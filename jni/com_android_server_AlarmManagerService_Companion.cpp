...
JNIEXPORT jint JNI_OnLoad(JavaVM* vm, void* reserved) {
    ...
    jclass c = env->FindClass("com/android/server/AlarmManagerService$Companion");
    if (c == nullptr) return JNI_ERR;

    // Register your class' native methods.
    int rc = env->RegisterNatives(c, android::sMethods, sizeof(android::sMethods)/sizeof(JNINativeMethod));
